...
<section class="accounts">
   ...
   <h1 class="heading">Cuestas de admins</h1>

   <div class="box-container">

   <div class="box">
      <p>Añadir un nuevo admin</p>
   ...
   <div class="box">
      ...
      <div class="flex-btn">
         <a href="admin_accounts.php?delete=<?= $fetch_accounts['id']; ?>" onclick="return confirm('¿Quieres borrar esta cuenta?')" class="delete-btn">Borrar</a>
         <?php
